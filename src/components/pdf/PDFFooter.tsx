...
export const PDFFooter: React.FC<PDFFooterProps> = ({
  ...
  return (
    <footer className="absolute bottom-0 left-0 right-0 w-full h-11 px-10 border-t border-slate-200 text-[10px] text-slate-500 flex justify-between items-center bg-slate-50 z-30 box-border pointer-events-none">
