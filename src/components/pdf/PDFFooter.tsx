...
export const PDFFooter: React.FC<PDFFooterProps> = ({
  ...
  return (
    <footer className="mt-auto px-10 py-3.5 border-t border-slate-200 text-[10px] text-slate-500 flex justify-between items-center bg-slate-50 shrink-0 z-20">
      <span className="truncate max-w-[500px] font-medium">{footerText}</span>
