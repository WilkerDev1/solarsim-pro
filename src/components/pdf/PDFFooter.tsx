...
export const PDFFooter: React.FC<PDFFooterProps> = ({
  ...
  return (
    <footer className="mt-auto w-full h-14 px-10 pt-2 pb-6 border-t border-slate-200 text-[10px] text-slate-500 flex justify-between items-start bg-slate-50 shrink-0 z-20 box-border">
