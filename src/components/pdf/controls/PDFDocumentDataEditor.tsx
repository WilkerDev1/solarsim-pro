...
export const PDFDocumentDataEditor: React.FC<PDFDocumentDataEditorProps> = ({
  ...
  // Accordion state
  const [openSection, setOpenSection] = useState<'company' | 'contact' | 'warranties' | 'services' | 'hardware'>('contact');
  ...
  return (
    <div className="space-y-3">
      {/* 1. SECCIÓN: IDENTIDAD DE LA EMPRESA EMISORA */}
      <div className={`rounded-xl border overflow-hidden transition-all ${isDark ? 'border-[#2a2a36] bg-[#1a1a24]' : 'border-slate-200 bg-white'}`}>
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span>1. Empresa Emisora y Marca</span>
          </div>
