      ...
      <div className="px-10 py-5 flex-1 flex flex-col justify-between text-xs text-slate-800 relative z-10 gap-3.5">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-4 gap-2.5">
            {/* Card 1 */}
            <div className="rounded-xl border border-slate-200 bg-white/95 p-2.5 flex flex-col justify-between shadow-xs">
              <div>
                <div
                  className="w-7 h-7 rounded-lg flex items-center justify-center text-white mb-1.5 shadow-2xs"
                  style={{ backgroundColor: activeTheme.primary }}
                >
                  <Wrench className="w-3.5 h-3.5" />
                </div>
                <h4 className="font-extrabold text-[11px] uppercase tracking-tight text-slate-900 leading-snug mb-1">
                  Instalación Profesional
                </h4>
                <p className="text-[9.5px] text-slate-600 leading-tight mb-2">
                  Ejecutamos la instalación bajo los más altos estándares técnicos y normativas eléctricas de seguridad.
                </p>
              </div>
              <ul className="text-[8.5px] text-slate-600 space-y-0.5 border-t border-slate-100 pt-1.5 font-medium">
