      ...
      <div className="px-10 py-6 flex-1 flex flex-col justify-between text-xs text-slate-800 relative z-10 gap-4">
        ...
        <div className="space-y-2.5">
          ...
          <div className="grid grid-cols-4 gap-2.5">
            {/* Card 1 */}
            <div className="rounded-xl border border-slate-200 bg-white/90 p-2.5 flex flex-col justify-between shadow-xs">
              <div>
                <div
                  className="w-8 h-8 rounded-lg flex items-center justify-center text-white mb-2 shadow-2xs"
                  style={{ backgroundColor: activeTheme.primary }}
                >
              ...
              <ul className="text-[9px] text-slate-600 space-y-0.5 border-t border-slate-100 pt-1.5 font-medium">
