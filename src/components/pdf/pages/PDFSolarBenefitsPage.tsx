      ...
      <div className="px-10 py-3.5 flex-1 flex flex-col justify-start gap-3 text-xs text-slate-800 relative z-10 min-h-0">
        ...
        <div className="space-y-1.5">
          ...
          <div className="rounded-2xl border border-slate-200 overflow-hidden bg-slate-900 relative shadow-sm">
            ...
            <div className="p-2 bg-white grid grid-cols-4 gap-1.5 border-t border-slate-100">
              <div className="p-1.5 rounded-xl bg-emerald-50/80 border border-emerald-200/80 text-center space-y-0.5">
                <div className="w-5 h-5 rounded-full bg-emerald-600 text-white flex items-center justify-center mx-auto shadow-2xs">
                  <DollarSign className="w-3 h-3" />
                </div>
                <h5 className="font-extrabold text-[9.5px] uppercase text-emerald-950">Ahorro en Factura</h5>
                <p className="text-[8px] text-slate-600 leading-tight">
                  Reducción inmediata de hasta un 95% del costo eléctrico mensual.
                </p>
              </div>

              <div className="p-1.5 rounded-xl bg-blue-50/80 border border-blue-200/80 text-center space-y-0.5">
                <div className="w-5 h-5 rounded-full bg-blue-600 text-white flex items-center justify-center mx-auto shadow-2xs">
                  <TrendingUp className="w-3 h-3" />
                </div>
                <h5 className="font-extrabold text-[9.5px] uppercase text-blue-950">Plusvalía Inmueble</h5>
                <p className="text-[8px] text-slate-600 leading-tight">
                  Incremento directo del valor comercial del inmueble o negocio.
                </p>
              </div>

              <div className="p-1.5 rounded-xl bg-amber-50/80 border border-amber-200/80 text-center space-y-0.5">
                <div className="w-5 h-5 rounded-full bg-amber-500 text-white flex items-center justify-center mx-auto shadow-2xs">
                  <Zap className="w-3 h-3" />
                </div>
                <h5 className="font-extrabold text-[9.5px] uppercase text-amber-950">Independencia</h5>
                <p className="text-[8px] text-slate-600 leading-tight">
                  Protección ante futuros incrementos tarifarios de las distribuidoras.
                </p>
              </div>

              <div className="p-1.5 rounded-xl bg-teal-50/80 border border-teal-200/80 text-center space-y-0.5">
                <div className="w-5 h-5 rounded-full bg-teal-600 text-white flex items-center justify-center mx-auto shadow-2xs">
                  <Leaf className="w-3 h-3" />
                </div>
                <h5 className="font-extrabold text-[9.5px] uppercase text-teal-950">Sostenibilidad</h5>
                <p className="text-[8px] text-slate-600 leading-tight">
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="p-2 rounded-xl border border-slate-200 bg-slate-50/90 flex items-start gap-2">
