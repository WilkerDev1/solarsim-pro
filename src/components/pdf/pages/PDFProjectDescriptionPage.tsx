    ...
    <div className="pdf-page w-[850px] h-[1202px] min-h-[1202px] max-h-[1202px] bg-white shadow-xl flex flex-col shrink-0 relative overflow-hidden font-sans print:shadow-none print:w-full print:min-h-screen">
      ...
      <div className="px-10 py-5 flex-1 flex flex-col justify-between text-xs text-slate-800 relative z-10 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="p-5 rounded-2xl border border-slate-200 bg-white/90 shadow-xs space-y-3.5 leading-relaxed text-justify">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3 rounded-xl border border-slate-200 bg-slate-50/80 flex items-center gap-3">
              <div
              ...
              <div>
                <span className="text-[10px] uppercase font-bold text-slate-400 block">Potencia DC</span>
            ...
            <div className="p-3 rounded-xl border border-slate-200 bg-slate-50/80 flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-emerald-600 text-white shadow-2xs shrink-0">
                <Sparkles className="w-4 h-4" />
              </div>
              <div>
                <span className="text-[10px] uppercase font-bold text-slate-400 block">Cobertura Solar</span>
            ...
            <div className="p-3 rounded-xl border border-slate-200 bg-slate-50/80 flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg flex items-center justify-center bg-blue-600 text-white shadow-2xs shrink-0">
                <BatteryCharging className="w-4 h-4" />
              </div>
              <div>
                <span className="text-[10px] uppercase font-bold text-slate-400 block">Generación Anual</span>
        ...
        <div className="rounded-2xl border-2 border-amber-300/80 bg-amber-50/70 p-5 shadow-xs space-y-3 relative overflow-hidden">
          ...
          <div className="space-y-2.5 text-amber-950/90 text-[11px] leading-relaxed text-justify font-medium">
