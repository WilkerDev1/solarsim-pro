          ...
          <table className="w-full text-left border-collapse flex-1">
            <thead className="text-white font-bold uppercase tracking-wider text-[10px] shrink-0" style={{ backgroundColor: activeTheme.primary }}>
              <tr>
                ...
                <th className="px-2 py-2 text-right">Energía Generada (kWh)</th>
                <th className="px-2 py-2 text-right">Ahorro Energía (USD)</th>
              ...
              {cf25.map((row) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-1 text-right font-semibold" style={{ color: activeTheme.primary }}>
